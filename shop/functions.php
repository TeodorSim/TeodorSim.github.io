...
if ( ! function_exists( 'get_product_data' )) {
    function get_product_data($product, $productId) {
        ...
        $productData['price'] = isset($product['fullPrice']) ? $product['fullPrice'] : '';
        $productData['price_old'] = isset($product['fullPriceOld']) ? $product['fullPriceOld'] : '';
...
if (! function_exists('get_np_shop_categories_filter_html')) {
    ...
    function get_np_shop_categories_filter_html($args) {
        ...
        // add item all
        $categories_filter_html .= strtr($args['itemTemplate'], array('{categories_filters_content}' => __('All', 'website6207873'), '{categories_filters_value}' => ''));
        // add item featured
        $item = strtr($args['itemTemplate'], array('{categories_filters_content}' => __('Featured', 'website6207873'), '{categories_filters_value}' => 'featured'));
